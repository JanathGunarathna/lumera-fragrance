...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 backdrop-blur-xl bg-panel/80 shadow-lg shadow-black/50 border-b border-gold/20 relative">
      <motion.div
      ...
      <div className="max-w-7xl mx-auto px-8 flex items-center justify-between h-20">
        <Link to="/" className="flex items-center group">
          <motion.img
            ...
            className="h-14 md:h-16 w-auto object-contain select-none drop-shadow-[0_0_14px_rgba(214,165,44,0.35)]"
            draggable="false"
